...
describe('checkTokenSafety', () => {
  ...
  describe('deduplication', () => {
    test('should pass duplicate tokens through (cached)', async () => {
      ...
      // First call
      const result1 = await checkTokenSafety(
        token,
        baseConfig,
        mockConnection,
        mockWallet.publicKey,
      ...
      const result2 = await checkTokenSafety(
        token,
        baseConfig,
        mockConnection,
        mockWallet.publicKey,
        ...
        value: [
          {
            ...
            decimals: 9,
            amount: '50000000000000', // Amount in base units (uiAmount * 10^decimals)
          },
        ],
      });
    });
        ...
        value: [
          {
            ...
            decimals: 9,
            amount: '150000000000000', // Amount in base units (uiAmount * 10^decimals)
          },
        ],
      });
