...
const mockEnhancedHoneypotDetection = jest.fn<Promise<HoneypotTestResult>, [PublicKey, PublicKey, number[]?, number?]>();
...
describe("Enhanced Honeypot Detection", () => {
    ...
    describe("Multi-amount testing logic", () => {
        it("should test multiple amounts and return results for each", async () => {
            ...
            const mockResult: HoneypotTestResult = {
                ...
                sellPass: true,
                multiAmountResults: [
                    { amount: 0.001, sellPass: true, expectedSol: 0.001, actualSol: 0.00095, valueRetained: 95 },
    ...
    describe("Multiple amount testing strategy", () => {
        ...
        it("should fail if any test amount fails sell simulation", async () => {
            ...
            const result = await mockEnhancedHoneypotDetection(testMint, testUserPubkey, [0.001, 0.01, 0.1]);
    ...
    describe("Tax threshold validation", () => {
        it("should use configurable sell tax threshold", async () => {
            ...
            const result = await mockEnhancedHoneypotDetection(testMint, testUserPubkey, [0.1], customThreshold);
