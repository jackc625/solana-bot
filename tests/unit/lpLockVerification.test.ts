...
import { verifyLpLockStatus, verifyTokenLpLock, LpLockStatus, LpLockConfig } from "../src/utils/lpLockVerification.js";
    ...
    describe("verifyLpLockStatus", () => {
        ...
        it("should detect LP tokens burned to burn address", async () => {
            ...
            mockConnection.getAccountInfo
                .mockResolvedValueOnce({ // First call for mint account
        ...
        it("should handle combination of burned and locked LP tokens", async () => {
            ...
            mockConnection.getAccountInfo
                ...
                .mockResolvedValueOnce({    // lock account
                    owner: lockProgram,
                    data: Buffer.alloc(0)
                });
        ...
        it("should handle errors gracefully", async () => {
            getMint.mockRejectedValue(new Error("Network error"));
